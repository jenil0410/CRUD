                ...
                <table id="table">
                    ...
                    <tbody style="text-align: center">
                        ...
                        <tr>
                            ...
                            <td>{{ $item->id }}</td>
                            <td>{{ $item->name }}</td>
                            <td> <a href="{{ route('role.edit',$item->id) }}" class="btn btn-primary btn-sm object-right">Edit</a>
                                <a href="{{ route('role.delete',$item->id) }}" class="btn btn-primary btn-sm object-right">Delete</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
